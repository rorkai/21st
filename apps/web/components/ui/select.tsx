...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollUpButton
    ...
    {...props}
  >
    <ChevronUpIcon width={16} height={16} strokeWidth={2} className="shrink-0 text-muted-foreground/80" />
  </SelectPrimitive.ScrollUpButton>
));
  ...
  >
    <span className="absolute start-2 flex size-3.5 items-center justify-center">
      <SelectPrimitive.ItemIndicator>
        <CheckIcon width={16} height={16} strokeWidth={2} className="shrink-0 text-muted-foreground/80" />
      </SelectPrimitive.ItemIndicator>
    </span>
